			...
			<form id="form1">
				...
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon2">Email</span> <input
						type="text" class="form-control"
						aria-describedby="basic-addon2" required id="correo_cliente" disabled="disabled">
				</div>
				...
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon5">Direccion</span> <input
						type="text" class="form-control"
						aria-describedby="basic-addon5" required id="direccion_cliente"  disabled="disabled">
				</div>
			</form>
...
<script>
		function enviar() {
				...
				req.open('GET', baseUrl + '/consultarcliente?cliente='+user, false);
				req.send(null);
				var usuario = null;
				if (req.status == 200)
			...
			if (usuario.toString()!=""){
				...
				document.getElementById("correo_cliente").value = usuario[0].correo_cliente;
